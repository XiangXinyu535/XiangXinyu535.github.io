...
$(document).ready(function () {
    ...
    var makeArithOpts = function () {						
            ...
            var opts_html = score_type == 'hundred' ? '<option value="standard_4" name="Standard4.0">Standard4.0</option><option value="improve1_4" name="To improve; to improve4.0(1)">To improve; to improve4.0(1)</option><option value="improve2_4" name="To improve; to improve4.0(2)">To improve; to improve4.0(2)</option><option value="Beida_4" name="Beijing University4.0">Beijing University4.0</option><option value="Canada_43" name="Beijing University4.0">Canada4.3</option><option value="USTC_43" name="China University of Science and Technology4.3">China University of Science and Technology4.3</option><option value="SJTU_43" name="Shanghai Jiaotong University4.3">Shanghai Jiaotong University4.3</option>' : score_type == 'five' ? '<option value="five" name="Five-point system">Five-point system</option>' : score_type == 'rank' ? '<option value="rank" name="Hierarchical system">Hierarchical system</option>' : '<option value=""></option>';
